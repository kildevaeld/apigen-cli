...
function app() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (argv.ast && !argv.generate)
            inputs.push(argv.ast);
        const filePromises = Promise.all(inputs.map((file) => __awaiter(this, void 0, void 0, function* () {
            try {
                return {
        ...
        generators_1.addGenerators(repo);
        let files;
        try {
            files = yield filePromises;
        }
        catch (e) {
            console.log(e);
        }
